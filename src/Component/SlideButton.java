...
//    label.setFont(new Font("Sans Serif", Font.PLAIN, 14));  // Set font and size
//    label.setForeground(Color.BLACK);  // Set text color
//
//    ImageIcon icon = new ImageIcon("src\\resource\\Vector.png"); // Replace with path to your icon
//    button = new JButton(icon);
//    button.setBorderPainted(false);  // Remove button border for cleaner look
//    button.setContentAreaFilled(false);  // Remove button background for cleaner look
//
//    add(label);
...
//  }
   public class SlideButton extends AbstractButton{
        ...
        public SlideButton(String trueLabel, String falseLabel) {
  ...
  // ... other methods (getButton, setText) remain the same
